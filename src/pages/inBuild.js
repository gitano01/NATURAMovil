    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{alignItems:'center',justifyContent:'center', alignContent:'center', width:'100%', height:'100%'}}>
                    <Image
                        style={{width: 190, height: 324}}
                        source={require('../images/working.png')}
                    />
                </View>
...
export default withNavigation(inBuild);